...
async function main() {
    ...
    const superAdmin = await prisma.user.upsert({
        ...
        update: { password: adminPasswordHash, role: client_1.UserRole.SUPER_ADMIN, status: client_1.UserStatus.ACTIVE },
        create: {
    ...
    const admin = await prisma.user.upsert({
        ...
        update: { password: adminPasswordHash, role: client_1.UserRole.ADMIN, status: client_1.UserStatus.ACTIVE },
        create: {
    ...
    const staff = await prisma.user.upsert({
        ...
        update: { password: staffPasswordHash, role: client_1.UserRole.STAFF, status: client_1.UserStatus.ACTIVE },
        create: {
    ...
    const customer = await prisma.user.upsert({
        ...
        update: { password: customerPasswordHash, role: client_1.UserRole.CUSTOMER, status: client_1.UserStatus.ACTIVE },
        create: {
    ...
    const roomsData = [
        ...
        },
        {
            ...
            type: client_1.RoomType.PRESIDENTIAL,
            status: client_1.RoomStatus.AVAILABLE,
            isAvailable: true,
            bedType: 'King',
            pricePerNight: 550.0,
        ...
        },
        {
            ...
            type: client_1.RoomType.EXECUTIVE,
            status: client_1.RoomStatus.AVAILABLE,
            isAvailable: true,
            bedType: 'Queen',
            pricePerNight: 190.0,
        ...
        },
        {
            ...
            type: client_1.RoomType.STANDARD,
            status: client_1.RoomStatus.AVAILABLE,
            isAvailable: true,
            bedType: 'Double',
            pricePerNight: 140.0,
